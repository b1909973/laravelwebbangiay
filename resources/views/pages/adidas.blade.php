...
<main>
        ...
        <div class="container">
            <h2 class="text-center my-4" style="color:  #303e48;"><i> Giày Adidas</i></h2>
            <div id='noidung'>
               <div class="row row-cols-4  justify-content-center">
                ...
                <div class="card  m-2 text-center" style="width: 18rem;">
                      ...
                      <div class="card-body">
                       ...
                       <!-- loi do chua them hinh anh -->         <img src="{{ asset('frontend/image/adidas/') }}{{ '/'.$item->HinhAnh}}" class="card-img-top" alt="...">  </button>
