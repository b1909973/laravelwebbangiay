	...
	<div class="container">
		  ...
		  <div class=" col-md-12 content ">
					...
					<div class="row col-md-12  mx-auto p-3 mt-2  rounded">
									...
									<a href="{{URL::to('/danggiao')}}" class="shipping text-decoration-none col-12 col-md-4 text-center p-2 border-bottom text-dark  fs-5" value="2">Đang giao</a>
									<a href="{{URL::to('/dagiao')}}" class="shipped text-decoration-none col-12 col-md-4 text-center link-secondary  p-2  border-bottom    fs-5" value="3">Đã giao</a>
							...
							<table class="table table-bordered">
							  ...
							  <tbody>
								...
								<td >
									...
									<td><i class="fas fa-check-circle fs-3 text-success" style="line-height: 120px;"></i></td>
									<td><button  class="tathienthi btn" value="{{$item->id}}"><i class="fas fa-eye-slash fs-3 text-danger " style="line-height: 120px;"></i></button></td>
								</tr>
							  </tbody>
							  @endforeach
							</table>
